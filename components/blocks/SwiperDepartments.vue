    ...
    <Swiper
      ...
      <SwiperSlide v-for="item in doubleItems" :key="item.id">
        <div class="department__item">
          <div class="department__item-img" :class="{ noImage: !item.image }">
            <nuxt-img
      ...
      <template v-slot:container-end>
        <div class="department__item-content-wrap">
          <div
            ...
            :key="item.id"
            :data-index="index">
            <div class="department__item-header" v-html="item.name"></div>
            <div class="department__item-text" v-html="item.description"></div>
            <template v-if="item.salary">
              <div class="department__item-salary" v-html="item.salary"></div>
              <div class="center-button">
                <elementsButton
                  class="button__trans-red"
                  :router-link="`/positions/${item.id}/`">
